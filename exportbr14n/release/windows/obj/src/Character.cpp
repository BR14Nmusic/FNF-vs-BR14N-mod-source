...
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_577_update,"Character","update",0x0e18944e,"Character.update","Character.hx",577,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_613_dance,"Character","dance",0xde4da48e,"Character.dance","Character.hx",613,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_674_playAnim,"Character","playAnim",0xed2bd3aa,"Character.playAnim","Character.hx",674,0xf073a2d5)
HX_LOCAL_STACK_FRAME(_hx_pos_ae240c01d039da8e_705_addOffset,"Character","addOffset",0x6dc9376f,"Character.addOffset","Character.hx",705,0xf073a2d5)
...
HXLINE( 394)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("br14n",5b,88,c4,b8)) ){
HXLINE( 500)			::String library = null();
HXDLIN( 500)			::String tex1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("br14n/br14n_assets",9b,88,bf,b6)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 500)			tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("br14n/br14n_assets",9b,88,bf,b6)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 501)			this->set_frames(tex);
HXLINE( 502)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("br14n_idle",b8,10,0d,e5),24,false,null(),null());
HXLINE( 503)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("br14n_up",ff,5e,2f,3b),24,false,null(),null());
HXLINE( 504)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("br14n_down",06,62,c7,e1),24,false,null(),null());
HXLINE( 505)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("br14n_left",ab,71,09,e7),24,false,null(),null());
HXLINE( 506)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("br14n_right",b8,11,47,b8),24,false,null(),null());
HXLINE( 508)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 509)			this->addOffset(HX_("singUP",6a,52,21,b9),null(),null());
HXLINE( 510)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 511)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),null(),null());
HXLINE( 512)			this->addOffset(HX_("singDOWN",31,2a,ad,36),null(),null());
HXLINE( 514)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 499)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("br14npurple",d7,b4,85,44)) ){
HXLINE( 534)			::String library = null();
HXDLIN( 534)			::String tex1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("br14n/br14npurple_assets",9f,b2,8e,de)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 534)			tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("br14n/br14npurple_assets",9f,b2,8e,de)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 535)			this->set_frames(tex);
HXLINE( 536)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("br14n_idle",b8,10,0d,e5),24,false,null(),null());
HXLINE( 537)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("br14n_up",ff,5e,2f,3b),24,false,null(),null());
HXLINE( 538)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("br14n_down",06,62,c7,e1),24,false,null(),null());
HXLINE( 539)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("br14n_left",ab,71,09,e7),24,false,null(),null());
HXLINE( 540)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("br14n_right",b8,11,47,b8),24,false,null(),null());
HXLINE( 542)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 543)			this->addOffset(HX_("singUP",6a,52,21,b9),null(),null());
HXLINE( 544)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 545)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),null(),null());
HXLINE( 546)			this->addOffset(HX_("singDOWN",31,2a,ad,36),null(),null());
HXLINE( 548)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 533)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("br14nred",d6,bb,3d,3b)) ){
HXLINE( 517)			::String library = null();
HXDLIN( 517)			::String tex1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("br14n/br14nred_assets",18,20,3d,e1)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 517)			tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(tex1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("br14n/br14nred_assets",18,20,3d,e1)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library));
HXLINE( 518)			this->set_frames(tex);
HXLINE( 519)			this->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("br14n_idle",b8,10,0d,e5),24,false,null(),null());
HXLINE( 520)			this->animation->addByPrefix(HX_("singUP",6a,52,21,b9),HX_("br14n_up",ff,5e,2f,3b),24,false,null(),null());
HXLINE( 521)			this->animation->addByPrefix(HX_("singDOWN",31,2a,ad,36),HX_("br14n_down",06,62,c7,e1),24,false,null(),null());
HXLINE( 522)			this->animation->addByPrefix(HX_("singLEFT",d6,39,ef,3b),HX_("br14n_left",ab,71,09,e7),24,false,null(),null());
HXLINE( 523)			this->animation->addByPrefix(HX_("singRIGHT",0d,6f,70,ac),HX_("br14n_right",b8,11,47,b8),24,false,null(),null());
HXLINE( 525)			this->addOffset(HX_("idle",14,a7,b3,45),null(),null());
HXLINE( 526)			this->addOffset(HX_("singUP",6a,52,21,b9),null(),null());
HXLINE( 527)			this->addOffset(HX_("singRIGHT",0d,6f,70,ac),null(),null());
HXLINE( 528)			this->addOffset(HX_("singLEFT",d6,39,ef,3b),null(),null());
HXLINE( 529)			this->addOffset(HX_("singDOWN",31,2a,ad,36),null(),null());
HXLINE( 531)			this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 516)			goto _hx_goto_0;
            		}
...
HXLINE( 142)			goto _hx_goto_0;
            		...
            		_hx_goto_0:;
HXLINE( 551)		this->dance();
HXLINE( 553)		if (( (bool)(isPlayer) )) {
HXLINE( 555)			this->set_flipX(!(this->flipX));
HXLINE( 558)			if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 561)				::Array< int > oldRight = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames;
HXLINE( 562)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHT",0d,6f,70,ac))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames;
HXLINE( 563)				( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFT",d6,39,ef,3b))) )->frames = oldRight;
HXLINE( 566)				if (::hx::IsNotNull( this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3)) )) {
HXLINE( 568)					::Array< int > oldMiss = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames;
HXLINE( 569)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singRIGHTmiss",89,cc,65,e3))) )->frames = ( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames;
HXLINE( 570)					( ( ::flixel::animation::FlxAnimation)(this->animation->_animations->get(HX_("singLEFTmiss",d2,2f,9c,b6))) )->frames = oldMiss;
            				}
            			}
            		}
            	}
...
void Character_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_577_update)
HXLINE( 578)		if (!(::StringTools_obj::startsWith(this->curCharacter,HX_("bf",c4,55,00,00)))) {
HXLINE( 580)			if (::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("sing",4f,96,53,4c))) {
HXLINE( 582)				 ::Character _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 582)				_hx_tmp->holdTimer = (_hx_tmp->holdTimer + elapsed);
            			}
HXLINE( 585)			Float dadVar = ( (Float)(4) );
HXLINE( 587)			if ((this->curCharacter == HX_("dad",47,36,4c,00))) {
HXLINE( 588)				dadVar = ((Float)6.1);
            			}
HXLINE( 589)			if ((this->holdTimer >= ((::Conductor_obj::stepCrochet * dadVar) * ((Float)0.001)))) {
HXLINE( 591)				this->dance();
HXLINE( 592)				this->holdTimer = ( (Float)(0) );
            			}
            		}
HXLINE( 596)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 599)			bool _hx_tmp;
HXDLIN( 599)			if ((this->animation->_curAnim->name == HX_("hairFall",bd,48,d6,cb))) {
HXLINE( 599)				_hx_tmp = this->animation->_curAnim->finished;
            			}
            			else {
...
void Character_obj::dance(){
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_613_dance)
HXDLIN( 613)		if (!(this->debugMode)) {
HXLINE( 615)			::String _hx_switch_0 = this->curCharacter;
            			if (  (_hx_switch_0==HX_("gf",1f,5a,00,00)) ){
HXLINE( 618)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 620)					this->danced = !(this->danced);
HXLINE( 622)					if (this->danced) {
HXLINE( 623)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 625)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 618)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-car",a6,63,ab,07)) ){
HXLINE( 640)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 642)					this->danced = !(this->danced);
HXLINE( 644)					if (this->danced) {
HXLINE( 645)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 647)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 640)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-christmas",94,26,b1,6d)) ){
HXLINE( 629)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 631)					this->danced = !(this->danced);
HXLINE( 633)					if (this->danced) {
HXLINE( 634)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 636)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 629)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("gf-pixel",98,3e,8c,55)) ){
HXLINE( 650)				if (!(::StringTools_obj::startsWith(this->animation->_curAnim->name,HX_("hair",22,27,08,45)))) {
HXLINE( 652)					this->danced = !(this->danced);
HXLINE( 654)					if (this->danced) {
HXLINE( 655)						this->playAnim(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            					}
            					else {
HXLINE( 657)						this->playAnim(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            					}
            				}
HXLINE( 650)				goto _hx_goto_21;
            			}
            			if (  (_hx_switch_0==HX_("spooky",eb,bd,9e,c1)) ){
...
HXLINE( 660)				goto _hx_goto_21;
            			}
            			/* default */{
HXLINE( 668)				this->playAnim(HX_("idle",14,a7,b3,45),null(),null(),null());
            			}
            			_hx_goto_21:;
            		}
            	}
...
void Character_obj::playAnim(::String AnimName,::hx::Null< bool >  __o_Force,::hx::Null< bool >  __o_Reversed,::hx::Null< int >  __o_Frame){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_674_playAnim)
HXLINE( 675)		this->animation->play(AnimName,Force,Reversed,Frame);
HXLINE( 677)		::cpp::VirtualArray daOffset = ( (::cpp::VirtualArray)(this->animOffsets->get(AnimName)) );
HXLINE( 678)		if (this->animOffsets->exists(AnimName)) {
HXLINE( 680)			this->offset->set(daOffset->__get(0),daOffset->__get(1));
            		}
            		else {
HXLINE( 683)			this->offset->set(0,0);
            		}
HXLINE( 685)		if ((this->curCharacter == HX_("gf",1f,5a,00,00))) {
HXLINE( 687)			if ((AnimName == HX_("singLEFT",d6,39,ef,3b))) {
HXLINE( 689)				this->danced = true;
            			}
            			else {
HXLINE( 691)				if ((AnimName == HX_("singRIGHT",0d,6f,70,ac))) {
HXLINE( 693)					this->danced = false;
            				}
            			}
HXLINE( 696)			bool _hx_tmp;
HXDLIN( 696)			if ((AnimName != HX_("singUP",6a,52,21,b9))) {
HXLINE( 696)				_hx_tmp = (AnimName == HX_("singDOWN",31,2a,ad,36));
            			}
            			else {
...
void Character_obj::addOffset(::String name,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_ae240c01d039da8e_705_addOffset)
HXDLIN( 705)		::cpp::VirtualArray v = ::Array_obj< Float >::__new(2)->init(0,x)->init(1,y);
HXDLIN( 705)		this->animOffsets->set(name,v);
            	}
