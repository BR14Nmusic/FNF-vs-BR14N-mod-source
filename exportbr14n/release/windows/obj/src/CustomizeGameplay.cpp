...
HXLINE( 475)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source_brian/Options.hx",4d,06,15,b5),475,HX_("CustomizeGameplay",29,ae,ab,0c),HX_("press",83,53,88,c8)));
HXLINE( 476)		{
