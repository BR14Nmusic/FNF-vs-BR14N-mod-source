...
HXLINE(  13)		::haxe::Log_obj::trace(HX_("Discord Client starting...",0d,5b,39,a8),::hx::SourceInfo(HX_("source_brian/Discord.hx",bf,e4,44,be),13,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
...
HXLINE(  20)		::haxe::Log_obj::trace(HX_("Discord Client started.",8e,09,8e,36),::hx::SourceInfo(HX_("source_brian/Discord.hx",bf,e4,44,be),20,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
...
HXDLIN(  49)		::haxe::Log_obj::trace((((HX_("Error! ",87,92,5b,b7) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source_brian/Discord.hx",bf,e4,44,be),49,HX_("DiscordClient",f7,d0,c5,2b),HX_("onError",29,6a,67,09)));
            	}
...
HXDLIN(  54)		::haxe::Log_obj::trace((((HX_("Disconnected! ",7a,e1,87,53) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source_brian/Discord.hx",bf,e4,44,be),54,HX_("DiscordClient",f7,d0,c5,2b),HX_("onDisconnected",7a,eb,5a,b8)));
            	}
...
HXLINE(  63)		::haxe::Log_obj::trace(HX_("Discord Client initialized",f3,a9,32,06),::hx::SourceInfo(HX_("source_brian/Discord.hx",bf,e4,44,be),63,HX_("DiscordClient",f7,d0,c5,2b),HX_("initialize",50,31,bb,ec)));
            	}
