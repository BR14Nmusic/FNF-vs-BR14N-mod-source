...
HXLINE(  46)				::haxe::Log_obj::trace( ::Dynamic(::PlayState_obj::SONG->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(i),::hx::SourceInfo(HX_("source_brian/EtternaFunctions.hx",9b,5a,e8,a9),46,HX_("EtternaFunctions",36,00,59,c6),HX_("getHolds",de,5d,34,8b)));
HXLINE(  47)				{
HXLINE(  47)					int _g1 = 0;
...
HXLINE(  50)						::haxe::Log_obj::trace(n,::hx::SourceInfo(HX_("source_brian/EtternaFunctions.hx",9b,5a,e8,a9),50,HX_("EtternaFunctions",36,00,59,c6),HX_("getHolds",de,5d,34,8b)));
