...
HXLINE( 207)			::haxe::Log_obj::trace(poop1,::hx::SourceInfo(HX_("source_brian/FreeplayState.hx",fa,01,b4,e5),207,HX_("FreeplayState",31,61,f2,b3),HX_("update",09,86,05,87)));
...
HXLINE( 213)			::haxe::Log_obj::trace((HX_("CUR WEEK",b4,9a,a0,36) + ::PlayState_obj::storyWeek),::hx::SourceInfo(HX_("source_brian/FreeplayState.hx",fa,01,b4,e5),213,HX_("FreeplayState",31,61,f2,b3),HX_("update",09,86,05,87)));
HXLINE( 214)			{
