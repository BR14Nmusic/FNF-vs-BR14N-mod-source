...
HXLINE( 153)		::haxe::Log_obj::trace(HX_("beat",76,e1,13,41),::hx::SourceInfo(HX_("source_brian/GameplayCustomizeState.hx",5d,65,9a,de),153,HX_("GameplayCustomizeState",74,30,cf,3c),HX_("beatHit",7d,ea,04,74)));
            	}
