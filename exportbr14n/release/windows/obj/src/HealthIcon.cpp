...
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_55_update,"HealthIcon","update",0x767ac302,"HealthIcon.update","HealthIcon.hx",55,0xf7836789)
...
HXLINE(  30)		this->animation->add(HX_("bf-old",5e,ba,eb,07),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_13,2),0,false,isPlayer,null());
HXLINE(  31)		this->animation->add(HX_("gf",1f,5a,00,00),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_14,1),0,false,isPlayer,null());
HXLINE(  32)		this->animation->add(HX_("gf-christmas",94,26,b1,6d),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_15,1),0,false,isPlayer,null());
HXLINE(  33)		this->animation->add(HX_("gf-pixel",98,3e,8c,55),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_16,1),0,false,isPlayer,null());
HXLINE(  34)		this->animation->add(HX_("parents-christmas",fe,94,c5,32),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_17,2),0,false,isPlayer,null());
...
HXLINE(  37)		this->animation->add(HX_("senpai",3c,df,8d,6b),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_20,2),0,false,isPlayer,null());
HXLINE(  38)		this->animation->add(HX_("senpai-angry",10,7a,b8,25),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_21,2),0,false,isPlayer,null());
HXLINE(  39)		this->animation->add(HX_("spirit",31,bb,a9,bd),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_22,2),0,false,isPlayer,null());
HXLINE(  40)		this->animation->add(HX_("br14n",5b,88,c4,b8),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_23,2),0,false,isPlayer,null());
HXLINE(  41)		this->animation->add(HX_("br14nred",d6,bb,3d,3b),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_24,2),0,false,isPlayer,null());
HXLINE(  42)		this->animation->add(HX_("br14npurple",d7,b4,85,44),::Array_obj< int >::fromData( _hx_array_data_f8f9be55_25,2),0,false,isPlayer,null());
HXLINE(  43)		this->animation->play(_hx_char,null(),null(),null());
HXLINE(  45)		::String _hx_switch_0 = _hx_char;
...
HXLINE(  48)			this->set_antialiasing(false);
HXDLIN(  48)			goto _hx_goto_0;
            		}
            		_hx_goto_0:;
HXLINE(  51)		this->scrollFactor->set(null(),null());
            	}
...
void HealthIcon_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_55_update)
HXLINE(  56)		this->super::update(elapsed);
HXLINE(  58)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE(  59)			Float _hx_tmp = this->sprTracker->x;
HXDLIN(  59)			Float _hx_tmp1 = ((_hx_tmp + this->sprTracker->get_width()) + 10);
HXDLIN(  59)			this->setPosition(_hx_tmp1,(this->sprTracker->y - ( (Float)(30) )));
            		}
            	}
