...
HXLINE(  38)		::haxe::Log_obj::trace(this->controlsStrings,::hx::SourceInfo(HX_("source_brian/LoadReplayState.hx",87,b1,bf,ba),38,HX_("LoadReplayState",c4,3c,20,8a),HX_("create",fc,66,0f,7c)));
...
HXLINE( 146)			::haxe::Log_obj::trace((HX_("loading ",24,de,81,cb) + this->actualNames->__get(this->curSelected)),::hx::SourceInfo(HX_("source_brian/LoadReplayState.hx",87,b1,bf,ba),146,HX_("LoadReplayState",c4,3c,20,8a),HX_("update",09,86,05,87)));
