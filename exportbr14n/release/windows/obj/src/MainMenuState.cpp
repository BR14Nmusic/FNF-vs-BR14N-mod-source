...
HXLINE( 195)									::haxe::Log_obj::trace(HX_("Freeplay Menu Selected",9c,6d,5a,ca),::hx::SourceInfo(HX_("source_brian/MainMenuState.hx",d2,c3,8a,e6),195,HX_("MainMenuState",59,88,5e,20),HX_("update",09,86,05,87)));
...
HXLINE( 191)									::haxe::Log_obj::trace(HX_("Story Menu Selected",71,ff,9b,4a),::hx::SourceInfo(HX_("source_brian/MainMenuState.hx",d2,c3,8a,e6),191,HX_("MainMenuState",59,88,5e,20),HX_("update",09,86,05,87)));
