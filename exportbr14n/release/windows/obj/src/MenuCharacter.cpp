...
HXLINE(  56)		this->animation->addByPrefix(HX_("br14n",5b,88,c4,b8),HX_("br14n_idle_black_line",1b,b1,45,f5),24,null(),null(),null());
...
HXDLIN(  24)			_g->set(HX_("br14n",5b,88,c4,b8), ::CharacterSetting_obj::__alloc( HX_CTX ,0,0,((Float)1.0),false));
HXDLIN(  24)			return _g;
            		}
