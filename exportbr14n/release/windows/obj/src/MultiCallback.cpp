...
HXLINE( 286)						::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + ((((HX_("fired ",72,04,21,89) + id) + HX_(", ",74,26,00,00)) + _gthis->numRemaining) + HX_(" remaining",d6,c2,10,c5))),::hx::SourceInfo(HX_("source_brian/LoadingState.hx",9c,c8,b9,de),305,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            					}
            				}
HXLINE( 288)				if ((_gthis->numRemaining == 0)) {
HXLINE( 290)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 291)						if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 291)							::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + HX_("all callbacks fired",5d,d8,ec,82)),::hx::SourceInfo(HX_("source_brian/LoadingState.hx",9c,c8,b9,de),305,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            						}
            					}
...
HXLINE( 296)					::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + (HX_("already fired ",fa,e7,0c,57) + id)),::hx::SourceInfo(HX_("source_brian/LoadingState.hx",9c,c8,b9,de),305,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            				}
            			}
            		}
...
HXLINE( 305)			::haxe::Log_obj::trace((((HX_("",00,00,00,00) + this->logId) + HX_(": ",a6,32,00,00)) + msg),::hx::SourceInfo(HX_("source_brian/LoadingState.hx",9c,c8,b9,de),305,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            		}
            	}
