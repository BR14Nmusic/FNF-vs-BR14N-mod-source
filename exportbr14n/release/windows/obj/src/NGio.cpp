...
HXLINE(  63)		::haxe::Log_obj::trace(HX_("connecting to newgrounds",49,1b,2e,55),::hx::SourceInfo(HX_("source_brian/NGio.hx",92,49,2d,99),63,HX_("NGio",5f,e0,c4,33),HX_("new",60,d0,53,00)));
...
HXLINE(  71)		::haxe::Log_obj::trace(::io::newgrounds::NG_obj::core->attemptingLogin,::hx::SourceInfo(HX_("source_brian/NGio.hx",92,49,2d,99),71,HX_("NGio",5f,e0,c4,33),HX_("new",60,d0,53,00)));
HXLINE(  73)		if (::io::newgrounds::NG_obj::core->attemptingLogin) {
HXLINE(  78)			::haxe::Log_obj::trace(HX_("attempting login",fe,74,81,50),::hx::SourceInfo(HX_("source_brian/NGio.hx",92,49,2d,99),78,HX_("NGio",5f,e0,c4,33),HX_("new",60,d0,53,00)));
...
HXDLIN(  92)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source_brian/NGio.hx",92,49,2d,99),92,HX_("NGio",5f,e0,c4,33),HX_("onNGLogin",31,a7,5b,25)));
...
HXDLIN( 143)		::haxe::Log_obj::trace(HX_("shoulda got score by NOW!",e0,b8,2d,75),::hx::SourceInfo(HX_("source_brian/NGio.hx",92,49,2d,99),143,HX_("NGio",5f,e0,c4,33),HX_("onNGBoardsFetch",b5,5d,77,86)));
            	}
...
HXLINE(  38)		::haxe::Log_obj::trace(HX_("INIT NOLOGIN",58,98,b9,6e),::hx::SourceInfo(HX_("source_brian/NGio.hx",92,49,2d,99),38,HX_("NGio",5f,e0,c4,33),HX_("noLogin",68,5d,f7,4b)));
...
HXLINE(  51)					::haxe::Log_obj::trace((HX_("CURRENT NG VERSION: ",5e,21,96,d2) + ::NGio_obj::GAME_VER),::hx::SourceInfo(HX_("source_brian/NGio.hx",92,49,2d,99),51,HX_("NGio",5f,e0,c4,33),HX_("noLogin",68,5d,f7,4b)));
HXLINE(  52)					::haxe::Log_obj::trace((HX_("CURRENT NG VERSION: ",5e,21,96,d2) + ::NGio_obj::GAME_VER_NUMS),::hx::SourceInfo(HX_("source_brian/NGio.hx",92,49,2d,99),52,HX_("NGio",5f,e0,c4,33),HX_("noLogin",68,5d,f7,4b)));
...
HXLINE( 188)		::haxe::Log_obj::trace((HX_("should have logged: ",b3,75,8c,3a) + event),::hx::SourceInfo(HX_("source_brian/NGio.hx",92,49,2d,99),188,HX_("NGio",5f,e0,c4,33),HX_("logEvent",f6,04,cb,60)));
            	}
