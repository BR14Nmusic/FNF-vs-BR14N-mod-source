...
HXDLIN(  88)		_hx_tmp(((_hx_tmp1 + this->path) + HX_(" replay...",07,d7,a1,13)),::hx::SourceInfo(HX_("source_brian/Replay.hx",6a,ea,67,8e),88,HX_("Replay",47,5b,16,3b),HX_("LoadFromJSON",f8,e4,96,25)));
HXLINE(  89)		try {
...
HXDLIN(  96)					_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source_brian/Replay.hx",6a,ea,67,8e),96,HX_("Replay",47,5b,16,3b),HX_("LoadFromJSON",f8,e4,96,25)));
            				}
            			}
            			else {
