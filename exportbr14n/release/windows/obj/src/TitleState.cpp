...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_358_createCoolText,"TitleState","createCoolText",0x83610287,"TitleState.createCoolText","TitleState.hx",358,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_369_addMoreText,"TitleState","addMoreText",0xcf420fae,"TitleState.addMoreText","TitleState.hx",369,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_379_deleteCoolText,"TitleState","deleteCoolText",0x8afda2b6,"TitleState.deleteCoolText","TitleState.hx",379,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_387_beatHit,"TitleState","beatHit",0xfba69a88,"TitleState.beatHit","TitleState.hx",387,0xd132a6e5)
...
HXDLIN(  64)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source_brian/TitleState.hx",f8,e8,09,06),64,HX_("TitleState",79,8d,a1,8c),HX_("create",fc,66,0f,7c)));
...
HXLINE( 158)		::Conductor_obj::changeBPM(102);
HXLINE( 159)		this->persistentUpdate = true;
HXLINE( 161)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,-16777216,null(),null());
HXLINE( 165)		this->add(bg);
...
HXDLIN( 168)		::String _hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("logoBumpin",26,cb,02,ab)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
HXDLIN( 168)		_hx_tmp->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp1,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("logoBumpin",26,cb,02,ab)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library)));
HXLINE( 169)		this->logoBl->set_antialiasing(true);
HXLINE( 170)		this->logoBl->animation->addByPrefix(HX_("bump",f6,0f,20,41),HX_("logo bumpin",70,a1,0b,72),24,false,null(),null());
HXLINE( 171)		this->logoBl->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
HXLINE( 172)		this->logoBl->updateHitbox();
HXLINE( 176)		this->versusBump =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-30,260,null());
HXLINE( 177)		 ::flixel::FlxSprite _hx_tmp2 = this->versusBump;
HXDLIN( 177)		::String library1 = null();
HXDLIN( 177)		::String _hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("versusbump",04,d6,22,42)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
HXDLIN( 177)		_hx_tmp2->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp3,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("versusbump",04,d6,22,42)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1)));
HXLINE( 178)		this->versusBump->set_antialiasing(true);
HXLINE( 179)		this->versusBump->animation->addByPrefix(HX_("bump",f6,0f,20,41),HX_("vsbr14nbump",f4,aa,38,58),24,false,null(),null());
HXLINE( 180)		this->versusBump->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
HXLINE( 181)		this->versusBump->updateHitbox();
HXLINE( 183)		this->gfDance =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.4)),(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.07)),null());
HXLINE( 184)		 ::flixel::FlxSprite _hx_tmp4 = this->gfDance;
HXDLIN( 184)		::String library2 = null();
HXDLIN( 184)		::String _hx_tmp5 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("gfDanceTitle",64,64,d2,7b)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2);
HXDLIN( 184)		_hx_tmp4->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp5,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("gfDanceTitle",64,64,d2,7b)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library2)));
HXLINE( 185)		this->gfDance->animation->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_6,16),HX_("",00,00,00,00),24,false,null(),null());
HXLINE( 186)		this->gfDance->animation->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_7,15),HX_("",00,00,00,00),24,false,null(),null());
HXLINE( 187)		this->gfDance->set_antialiasing(true);
HXLINE( 189)		this->add(this->gfDance);
HXLINE( 190)		this->add(this->logoBl);
HXLINE( 191)		this->add(this->versusBump);
HXLINE( 193)		this->titleText =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,100,(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.8)),null());
HXLINE( 194)		 ::flixel::FlxSprite _hx_tmp6 = this->titleText;
HXDLIN( 194)		::String library3 = null();
HXDLIN( 194)		::String _hx_tmp7 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("titleEnter",60,80,6b,82)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library3);
HXDLIN( 194)		_hx_tmp6->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp7,::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("titleEnter",60,80,6b,82)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library3)));
HXLINE( 195)		this->titleText->animation->addByPrefix(HX_("idle",14,a7,b3,45),HX_("Press Enter to Begin",e9,79,2c,83),24,null(),null(),null());
HXLINE( 196)		this->titleText->animation->addByPrefix(HX_("press",83,53,88,c8),HX_("ENTER PRESSED",5a,47,9f,63),24,null(),null(),null());
HXLINE( 197)		this->titleText->set_antialiasing(true);
HXLINE( 198)		this->titleText->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
HXLINE( 199)		this->titleText->updateHitbox();
HXLINE( 201)		this->add(this->titleText);
HXLINE( 203)		 ::flixel::FlxSprite logo =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXDLIN( 203)		::String library4 = null();
HXDLIN( 203)		 ::flixel::FlxSprite logo1 = logo->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("logo",6b,9f,b7,47)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library4),null(),null(),null(),null(),null());
HXLINE( 204)		logo1->screenCenter(null());
HXLINE( 205)		logo1->set_antialiasing(true);
HXLINE( 211)		this->credGroup =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE( 212)		this->add(this->credGroup);
HXLINE( 213)		this->textGroup =  ::flixel::group::FlxTypedGroup_obj::__alloc( HX_CTX ,null());
HXLINE( 215)		this->blackScreen =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,-16777216,null(),null());
HXLINE( 216)		this->credGroup->add(this->blackScreen).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 218)		this->credTextShit =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("ninjamuffin99\nPhantomArcade\nkawaisprite\nevilsk8er",fd,7d,e3,3b),true,null());
HXLINE( 219)		this->credTextShit->screenCenter(null());
HXLINE( 223)		this->credTextShit->set_visible(false);
HXLINE( 225)		 ::flixel::FlxSprite _hx_tmp8 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.52)),null());
HXDLIN( 225)		::String library5 = null();
HXDLIN( 225)		this->ngSpr = _hx_tmp8->loadGraphic(::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("newgrounds_logo",1e,5c,8d,a6)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library5),null(),null(),null(),null(),null());
HXLINE( 226)		this->add(this->ngSpr);
HXLINE( 227)		this->ngSpr->set_visible(false);
HXLINE( 228)		 ::flixel::FlxSprite _hx_tmp9 = this->ngSpr;
HXDLIN( 228)		_hx_tmp9->setGraphicSize(::Std_obj::_hx_int((this->ngSpr->get_width() * ((Float)0.8))),null());
HXLINE( 229)		this->ngSpr->updateHitbox();
HXLINE( 230)		this->ngSpr->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 231)		this->ngSpr->set_antialiasing(true);
HXLINE( 233)		::flixel::tweens::FlxTween_obj::tween(this->credTextShit, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 235)		::flixel::FlxG_obj::mouse->set_visible(false);
...
HXDLIN( 268)		if (_this->keyManager->checkStatus(70,_this->status)) {
...
HXDLIN( 273)		bool pressedEnter = _this1->keyManager->checkStatus(13,_this1->status);
HXLINE( 285)		 ::flixel::input::gamepad::FlxGamepad gamepad = ::flixel::FlxG_obj::gamepads->lastActive;
HXLINE( 287)		if (::hx::IsNotNull( gamepad )) {
HXLINE( 289)			 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this = gamepad->justPressed;
HXDLIN( 289)			int id = 7;
HXDLIN( 289)			 ::flixel::input::gamepad::FlxGamepad _this1 = _this->gamepad;
HXDLIN( 289)			int Status = _this->status;
HXDLIN( 289)			bool _hx_tmp;
HXDLIN( 289)			switch((int)(id)){
            				case (int)-2: {
HXLINE( 289)					_hx_tmp = _this1->anyButton(Status);
            				}
            				break;
            				case (int)-1: {
HXLINE( 289)					_hx_tmp = !(_this1->anyButton(Status));
            				...
            				break;
            				default:{
HXLINE( 289)					int RawID = _this1->mapping->getRawID(id);
HXDLIN( 289)					 ::flixel::input::gamepad::FlxGamepadButton button = _this1->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
...
HXDLIN( 298)		if (pressedEnter) {
HXLINE( 298)			_hx_tmp1 = !(this->transitioning);
            		}
            		else {
HXLINE( 298)			_hx_tmp1 = false;
            		}
HXDLIN( 298)		if (_hx_tmp1) {
HXLINE( 298)			_hx_tmp = this->skippedIntro;
            		}
            		else {
...
HXDLIN( 325)					::String s = ::MainMenuState_obj::kadeEngineVer;
HXDLIN( 325)					if ((s.indexOf(::StringTools_obj::trim(data),null()) == -1)) {
HXLINE( 325)						_hx_tmp1 = !(::OutdatedSubState_obj::leftState);
            					}
            					else {
HXLINE( 325)						_hx_tmp1 = false;
            					}
HXDLIN( 325)					if (_hx_tmp1) {
HXLINE( 325)						_hx_tmp = (::MainMenuState_obj::nightly == HX_("",00,00,00,00));
            					}
            					else {
...
HXDLIN( 327)						::String _hx_tmp1 = ((HX_("outdated lmao! ",46,1a,a2,c7) + ::StringTools_obj::trim(data)) + HX_(" != ",84,13,40,15));
HXDLIN( 327)						_hx_tmp((_hx_tmp1 + ::MainMenuState_obj::kadeEngineVer),::hx::SourceInfo(HX_("source_brian/TitleState.hx",f8,e8,09,06),327,HX_("TitleState",79,8d,a1,8c),HX_("update",09,86,05,87)));
HXLINE( 328)						::OutdatedSubState_obj::needVer = data;
HXLINE( 329)						{
...
HXLINE( 338)					::haxe::Log_obj::trace((HX_("error: ",6e,80,0a,ea) + error),::hx::SourceInfo(HX_("source_brian/TitleState.hx",f8,e8,09,06),338,HX_("TitleState",79,8d,a1,8c),HX_("update",09,86,05,87)));
HXLINE( 339)					{
...
HXLINE( 321)				 ::sys::Http http =  ::sys::Http_obj::__alloc( HX_CTX ,HX_("https://raw.githubusercontent.com/KadeDev/Kade-Engine/master/version.downloadMe",75,a0,51,4f));
HXLINE( 323)				http->onData =  ::Dynamic(new _hx_Closure_0());
...
HXLINE( 301)				 ::io::newgrounds::objects::Medal medal = ( ( ::io::newgrounds::objects::Medal)(::io::newgrounds::NG_obj::core->medals->get(60960)) );
HXDLIN( 301)				if (!(( (bool)(medal->_data->__Field(HX_("unlocked",23,34,0e,5c),::hx::paccDynamic)) ))) {
HXLINE( 301)					medal->sendUnlock();
            				}
            			}
HXLINE( 304)			if ((::Date_obj::now()->getDay() == 5)) {
HXLINE( 305)				if (::NGio_obj::isLoggedIn) {
HXLINE( 305)					 ::io::newgrounds::objects::Medal medal = ( ( ::io::newgrounds::objects::Medal)(::io::newgrounds::NG_obj::core->medals->get(61034)) );
HXDLIN( 305)					if (!(( (bool)(medal->_data->__Field(HX_("unlocked",23,34,0e,5c),::hx::paccDynamic)) ))) {
HXLINE( 305)						medal->sendUnlock();
            					}
            				}
            			}
HXLINE( 308)			this->titleText->animation->play(HX_("press",83,53,88,c8),null(),null(),null());
HXLINE( 310)			::flixel::FlxG_obj::camera->flash(-1,1,null(),null());
HXLINE( 311)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 311)			_hx_tmp->play(::Paths_obj::sound(HX_("confirmMenu",bf,8e,fe,3c),null()),((Float)0.7),null(),null(),null(),null());
HXLINE( 313)			this->transitioning = true;
...
HXDLIN( 348)		if (pressedEnter) {
HXLINE( 348)			_hx_tmp3 = !(this->skippedIntro);
            		}
            		else {
HXLINE( 348)			_hx_tmp3 = false;
            		}
HXDLIN( 348)		if (_hx_tmp3) {
HXLINE( 348)			_hx_tmp2 = ::TitleState_obj::initialized;
            		}
            		else {
HXLINE( 348)			_hx_tmp2 = false;
            		}
HXDLIN( 348)		if (_hx_tmp2) {
HXLINE( 350)			this->skipIntro();
            		}
...
void TitleState_obj::createCoolText(::Array< ::String > textArray){
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_358_createCoolText)
HXDLIN( 358)		int _g = 0;
HXDLIN( 358)		int _g1 = textArray->length;
HXDLIN( 358)		while((_g < _g1)){
HXDLIN( 358)			_g = (_g + 1);
HXDLIN( 358)			int i = (_g - 1);
HXLINE( 360)			 ::Alphabet money =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),textArray->__get(i),true,false);
HXLINE( 361)			money->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 362)			{
HXLINE( 362)				 ::Alphabet _g1 = money;
HXDLIN( 362)				_g1->set_y((_g1->y + ((i * 60) + 200)));
            			}
HXLINE( 363)			this->credGroup->add(money).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 364)			this->textGroup->add(money).StaticCast<  ::flixel::FlxBasic >();
            		}
            	}
...
void TitleState_obj::addMoreText(::String text){
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_369_addMoreText)
HXLINE( 370)		 ::Alphabet coolText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),text,true,false);
HXLINE( 371)		coolText->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE( 372)		{
HXLINE( 372)			 ::Alphabet _g = coolText;
HXDLIN( 372)			_g->set_y((_g->y + ((this->textGroup->length * 60) + 200)));
            		}
HXLINE( 373)		this->credGroup->add(coolText).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 374)		this->textGroup->add(coolText).StaticCast<  ::flixel::FlxBasic >();
            	}
...
void TitleState_obj::deleteCoolText(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_379_deleteCoolText)
HXDLIN( 379)		while((this->textGroup->members->get_length() > 0)){
HXLINE( 381)			this->credGroup->remove(Dynamic( this->textGroup->members->__get(0)).StaticCast<  ::flixel::FlxBasic >(),true).StaticCast<  ::flixel::FlxBasic >();
HXLINE( 382)			this->textGroup->remove(Dynamic( this->textGroup->members->__get(0)).StaticCast<  ::flixel::FlxBasic >(),true).StaticCast<  ::flixel::FlxBasic >();
            		}
            	}
...
void TitleState_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_387_beatHit)
HXLINE( 388)		this->super::beatHit();
HXLINE( 390)		this->versusBump->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
...
void TitleState_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(versusBump,"versusBump");
...
void TitleState_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(versusBump,"versusBump");
...
::hx::Val TitleState_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"versusBump") ) { return ::hx::Val( versusBump ); }
...
::hx::Val TitleState_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"versusBump") ) { versusBump=inValue.Cast<  ::flixel::FlxSprite >(); return inValue; }
		break;
	case 11:
...
void TitleState_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("versusBump",24,02,fc,2c));
...
static ::hx::StorageInfo TitleState_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::FlxSprite */ ,(int)offsetof(TitleState_obj,versusBump),HX_("versusBump",24,02,fc,2c)},
