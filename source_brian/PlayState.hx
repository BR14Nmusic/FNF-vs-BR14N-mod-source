...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'instruction':
				dialogue = CoolUtil.coolTextFile(Paths.txt('instruction/instructionDialogue'));
			case 'bugged':
				dialogue = CoolUtil.coolTextFile(Paths.txt('bugged/buggedDialogue'));
			case 'execute':
				dialogue = CoolUtil.coolTextFile(Paths.txt('execute/executeDialogue'));
		}
			...
			case 'br14nRoom':
				{
					defaultCamZoom = 0.70;
					curStage = 'br14nRoom';
					var bg:FlxSprite = new FlxSprite( -501.7, -590.8).loadGraphic(Paths.image('br14n/br14nbg'));
					bg.antialiasing = true;
	...
	*/
	...
	override function beatHit()
	{
		...
		if (SONG.notes[Math.floor(curStep / 16)] != null)
		{
			...
			// THE FUTURE IS NOW
			// ignore my jank coding ;-; i just wanted dance to work
